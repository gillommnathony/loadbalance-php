 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/r-2.2.6/sc-2.0.3/sp-1.2.1
 *
 * Included libraries:
 *   DataTables 1.10.22, Responsive 2.2.6, Scroller 2.0.3, SearchPanes 1.2.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.22/r-2.2.6/sc-2.0.3/sp-1.2.1",
